<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Customer/CustomerM1.Master" EnableEventValidation="false" CodeBehind="MakePayment.aspx.cs" Inherits="ContainerManagementSystem.Customer.MakePayment" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <EditItemTemplate>
     ...
     <EditItemTemplate>
         <asp:TextBox ID="txtPrice" width="70px"  runat="server" Text='<%#Eval("Price") %>'/>
     </EditItemTemplate>
     ...
     <EditItemTemplate>
         <asp:TextBox ID="txtWeight" width="70px"  runat="server" Text='<%#Eval("Weight") %>'/>
     </EditItemTemplate>
     ...
     <EditItemTemplate>
         <asp:TextBox ID="txtDescription" width="70px"  runat="server" Text='<%#Eval("Description") %>'/>
     </EditItemTemplate>
    ...
    <ItemTemplate>
        ...
        <asp:Button ID="ButtonDelete" runat="server" CommandName="Delete"  Text="Make Payment" onclientclick="javascript:return window.confirm('Your Payment has been successfully done!!')"  />
    </ItemTemplate>
