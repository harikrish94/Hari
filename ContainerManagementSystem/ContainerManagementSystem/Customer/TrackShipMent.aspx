<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Customer/CustomerM1.Master" EnableEventValidation="false" CodeBehind="TrackShipMent.aspx.cs" Inherits="ContainerManagementSystem.Customer.TrackShipMent" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowDataBound="GridView1_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Status">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="Status" Width="70px" runat="server" BorderColor="Black" Text='<%#Eval("Status") %>' />
                            </EditItemTemplate>
