<%@ Page Title="Register" Language="C#" MasterPageFile="~/Admin/AdminM.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="ContainerManagementSystem.Account.Register" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <fieldset>
                        ...
                        <ol>
                            ...
                            <li><br />
                                 <asp:Button ID="Button1" runat="server"  Text="Add Partner" OnClick="Button1_Click" />
                            </li>
                        </ol>
