<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginN.aspx.cs" Inherits="ContainerManagementSystem.LoginN" %>

<!DOCTYPE html>
<html>
<head>
    <title>Your Complete Vacation Planning Specialist</title>
...
<body>
    ...
    <form id="frm1" name="guest" runat="server">
        <div id="AgentHome">
                            ...
                            <div class="lf_pad">
                                <div class="lf_content_box">
                                    <div class="lf_link_box_12936095 info">
                                        <ul>
                                            <li class="odd first"><a href="#">Tel : 770-981-6461</a></li>
                                            <li class="even last"><a href="#">info@comecruise.com</a></li>
                                        </ul>
                                    </div>
                                    <div class="lf_link_box_12936094 social_icons">
                                        <ul>
                                            ...
                                            <li class="odd last"><a href="https://www.facebook.com/Come-Cruise-with-Us-Tours-Travel-117086591658089/" target="_blank">
                                ...
                                <div id="content">
                                    <div class="lf_pad">
                                        ...
                                        <div class="lf_main">
                                            <div class="lf_content_box">
                                                <div class="tideBody">
                                                    <h3 class="heading_1" id="heading_1">Most Popular Packages</h3>
                                                </div>
                                                <div class="lf_link_box_12936127 content">
                                                    <ul>
                                                            ...
                                                            <div align="center">
                                                                <fieldset style="width: 800px;">
                                                                    ...
                                                                    <div class='container'>
                                                                        ...
                                                                        <br />
                                                                        <asp:TextBox ID="txtPwd" runat="server" Width="300px" Height="30px"></asp:TextBox>
                                                        ...
                                                        <!--<li class="odd"><a href="http://content.onlineagency.com/c/15/15101/26789_15101.htm"><img src="site-files/images/v_5.png" height="196"  width="301" alt="" border="0"></a></li>
    <li class="even last"><a href="http://content.onlineagency.com/c/15/15101/1657_15101.htm"><img src="site-files/images/v_6.png" height="196"  width="301" alt="" border="0"></a></li>-->
                                                    </ul>
                                                </div>
                            ...
                            <div class="lf_pad">
                                <div class="lf_content_box">
                                    <div class="contact_info">
                                        ...
                                        <ul>
                                            <li>&nbsp;</li>
                                            <li>Come Cruise With Us &amp; Tours, Inc.</li>
                                            <li>Lithonia, GA 30038</li>
                                            <li>(770) 981-6461</li>
                                    ...
                                    <div class="mail_id">
                                        ...
                                        <table width="100%" cellpadding="1" cellspacing="0">
                                            <tr>
                                                <td class="tideFormTitle">

                                                    <table width="100%" cellpadding="3" cellspacing="0">
                                                    <td class="tideFormBody">
                                                        <input class="tideFormInput" placeholder="Enter Your Name" type="" name="quick_reg_first" size="20" value=""><br />
                                                        <br />
                                                    </td>
                                            </tr>
                                            ...
                                            <td class="tideFormBody">
                                                <input class="tideFormInput" type="" placeholder="Email Your Address" name="quick_reg_email" size="20" value="">

                                                <input type="text" name="email2" style="display: none;">
                                                <input type="text" name="lf_subject" style="display: none;">
                                                <input type="text" name="lf_email" style="display: none;">
                                                <input type="text" name="lf_url" style="display: none;">
                                                <input type="hidden" name="quick_reg" value="Y">
                                                <br />
                                                <br />
                                                <input type="submit" id="submit" name="submit" class="submit" value="Submit" /><br />
...
</div><div class="tidePoweredBy" id="lf_poweredby"></div>
    <!-- TIDE_PAGE_END -->
